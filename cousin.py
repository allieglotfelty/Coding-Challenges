...
Nodes `k` and `l` are at same level ("cousins", as we'll call them, but removed
...
class Node(object):
    ...
    def cousins(self):
        ...
        #     for parent_child in grandparent.children:
        #         for child in parent_child.children:
        #             if child != self:
        #                 cousin_names.add(child)
        # else:
